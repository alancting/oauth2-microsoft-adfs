...
use Alancting\OAuth2\OpenId\Client\Security\Credential\AdfsOAuthCredential;
use Alancting\OAuth2\OpenId\Client\Test\Base\AbstractAdfsTestCase;
use Mockery as m;

class AdfsOAuthCredentialTest extends AbstractAdfsTestCase
{
    ...
    {
        $configuration = m::mock('alias:Alancting\Microsoft\JWT\AzureAd\AzureAdConfiguration');
    ...
    private function _getOAuthCredential($opts = [])
    {
        ...
        $oAuthCredential = new AdfsOAuthCredential(
