...
use Alancting\OAuth2\OpenId\Client\Security\Authenticator\AzureAdAuthenticator;
...
class AzureAdAuthenticatorTest extends AbstractAzureAdTestCase
{
    protected $router;
    protected $security;
    ...
    {
        $mocks = [
            'mock_oauth_credential' => m::mock('Alancting\OAuth2\OpenId\Client\Security\Credential\AzureAdOAuthCredential'),
        ];
    ...
    private function getSimpleAuthenticator($mocks = [])
    {
        ...
        return new AzureAdAuthenticator(
